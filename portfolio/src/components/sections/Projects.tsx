...
// 1. Atualizei a estrutura de dados para incluir imgSrc
const highlightedProjects = [
  {
    ...
    accent: "#20F088",
    // Mantemos as config do placeholder caso a imagem falhe
  ...
  },
  {
    ...
    imgSrc: "/plante-comigo.png", // Lembre-se de salvar a imagem do projeto nesta pasta
    accent: "#6b7c67", // Um tom de verde oliva/musgo elegante
  ...
  },
  {
    ...
    imgSrc: "/clinica-fono.png", // Adicione a imagem
    accent: "#38bdf8",
  ...
  },
  {
    ...
    imgSrc: "/itatiaia.png", // Adicione a imagem
    accent: "#f59e0b",
...
// 2. Renomeei e modifiquei o componente para aceitar imagem
...
function ProjectMedia({ imgSrc, title, icon, accent, gradient }: ProjectMediaProps) {
  // Estilo base do container (comum para imagem e placeholder)
  const containerStyle: React.CSSProperties = {
    height: '220px', // Aumentei um pouco a altura para valorizar a imagem
    position: 'relative',
    overflow: 'hidden',
    display: 'flex',
    alignItems: 'center',
  ...
  // SE HOUVER IMAGEM, renderiza a tag img
  if (imgSrc) {
    return (
      <div style={containerStyle}>
        <img 
          ...
          style={{
            width: '100%',
            height: '100%',
            objectFit: 'cover', // Importante para não distorcer
            objectPosition: 'center top', // Foca no topo da página, geralmente onde fica o header
          }}
        />
      </div>
    );
  ...
  // CASO CONTRÁRIO, renderiza o placeholder original
  return (
    <div style={{
      ...containerStyle,
  ...
  return (
    <section id="projetos" style={{ padding: '7rem 0' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{
          display: 'grid',
          // Ajustei o minmax para acomodar melhor os cards com imagem em telas menores
          ...
          {highlightedProjects.map((project, i) => (
            ...
            >
              {/* 3. Chame o componente atualizado passando imgSrc e title */}
              <ProjectMedia
                imgSrc={project.imgSrc}
                title={project.title}
                icon={project.icon}
                accent={project.accent}
                gradient={project.placeholderColor}
              />
              ...
              <div style={{ padding: '1.75rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <p style={{
                  color: 'rgba(255,255,255,0.6)', // Aumentei um pouco a opacidade para leitura sobre o glass
                  fontSize: '0.85rem',
                  lineHeight: 1.75,
                  marginBottom: '1.5rem',
                  flex: 1, // Empurra as techs e o CTA para baixo
                  fontWeight: 300,
                }}>
                  {project.desc}
                </p>
